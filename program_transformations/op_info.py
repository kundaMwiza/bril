...
import dataclasses
from .cfg import InstructionBase, PlaceholderInstr, Instruction, Dtype
...
class ResolveArgType:
    @classmethod
    def _impl(cls, arg_name: str, instr: InstructionBase):
        raise NotImplementedError

    @classmethod
    def resolve(cls, arg_name: str , instr: InstructionBase):
...
class ControlOpResolver(ResolveArgType):
    @classmethod
    def _impl(self, arg_name: str, instr: InstructionBase):
...
def resolve_arg_type(arg_name: str, instr: InstructionBase) -> Dtype | OpArgTypeResolveFailure:
