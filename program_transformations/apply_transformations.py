...
def main(args):
    ...
    transformations.apply_transformations(
        original_program, transformations=args.transformations, preset=args.preset
    )
...
if __name__ == "__main__":
    ...
    transformations_group.add_argument(
        ...
        type=str,
        nargs="*",
        choices=transformations.AVAILABLE_TRANSFORMATIONS.keys(),
        default=[],
    )
    transformations_group.add_argument(
        "--preset",
        type=str,
        choices=transformations.TRANSFORMATION_PRESETS.keys(),
        default="default",
    )
